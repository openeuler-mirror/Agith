...
macro(bpf_object name input)
  ...
  add_library(${name} OBJECT ${BPF_C_FILE})
  target_include_directories(${name} PRIVATE ${GENERATED_VMLINUX_DIR})
  target_compile_options(${name} PRIVATE
    -g -O2 -target bpf -D__TARGET_ARCH_${ARCH} ${CLANG_SYSTEM_INCLUDES}
